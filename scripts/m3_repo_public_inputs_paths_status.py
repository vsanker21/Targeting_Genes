#!/usr/bin/env python3
"""
Outline M3: presence of module3_public_inputs_status JSON/flag under results/module3.

Config: config/m3_repo_public_inputs_outline_inputs.yaml — m3_repo_public_inputs_path_checks
"""
...
def main() -> int:
    ...
    block = doc.get("m3_repo_public_inputs_path_checks") or {}
    if not block.get("enabled", True):
        print("m3_repo_public_inputs_path_checks disabled")
        return 0
    ...
    note = (
        "M3 manifest slice for module3_public_inputs_status under results/module3; "
        "data_root public GEO/SRA/Dryad trees remain in module3_inputs.yaml public_path_checks."
    )
    out_doc = {
    ...
    d_out = "results/module3/m3_repo_public_inputs_paths_status.json"
    d_flag = "results/module3/m3_repo_public_inputs_paths_status.flag"
