#!/usr/bin/env python3
"""
Outline M3: presence of m3_geo_pipelines_mirror path-status + integration stub artifacts under results/module3.

Config: config/m3_repo_geo_pipelines_mirror_outline_inputs.yaml — m3_repo_geo_pipelines_mirror_path_checks
"""
...
def main() -> int:
    ...
    block = doc.get("m3_repo_geo_pipelines_mirror_path_checks") or {}
    if not block.get("enabled", True):
        print("m3_repo_geo_pipelines_mirror_path_checks disabled")
        return 0
    ...
    note = (
        "M3 manifest slice for m3_geo_pipelines_mirror_paths_status and m3_geo_pipelines_mirror_integration_stub "
        "under results/module3; data_root GEO/pipelines trees remain in m3_geo_pipelines_mirror_outline_inputs.yaml."
    )
    out_doc = {
    ...
    d_out = "results/module3/m3_repo_geo_pipelines_mirror_paths_status.json"
    d_flag = "results/module3/m3_repo_geo_pipelines_mirror_paths_status.flag"
