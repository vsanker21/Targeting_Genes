...
Config: config/m3_repo_m2_2_depmap_mirror_outline_inputs.yaml — m3_repo_m2_2_depmap_mirror_path_checks
"""
...
def main() -> int:
    ...
    block = doc.get("m3_repo_m2_2_depmap_mirror_path_checks") or {}
    if not block.get("enabled", True):
        print("m3_repo_m2_2_depmap_mirror_path_checks disabled")
        return 0
