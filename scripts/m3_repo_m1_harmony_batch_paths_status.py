#!/usr/bin/env python3
"""
Outline M1: presence of m1_harmony_batch path-status + integration stub artifacts under results/module3.

Config: config/m3_repo_m1_harmony_batch_outline_inputs.yaml — m3_repo_m1_harmony_batch_path_checks
"""
...
def main() -> int:
    ...
    block = doc.get("m3_repo_m1_harmony_batch_path_checks") or {}
    if not block.get("enabled", True):
        print("m3_repo_m1_harmony_batch_path_checks disabled")
        return 0
    ...
    note = (
        "M3 manifest slice for m1_harmony_batch_paths_status and m1_harmony_batch_integration_stub; "
        "data_root paths remain in m1_harmony_batch_outline_inputs.yaml."
    )
    out_doc = {
    ...
    d_out = "results/module3/m3_repo_m1_harmony_batch_paths_status.json"
    d_flag = "results/module3/m3_repo_m1_harmony_batch_paths_status.flag"
