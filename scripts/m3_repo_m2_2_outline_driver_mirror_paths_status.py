#!/usr/bin/env python3
"""
Outline M2: presence check for M2 mirror quartet under results/module3 (M3 manifest slice).

Config: config/m3_repo_m2_2_outline_driver_mirror_outline_inputs.yaml — m3_repo_m2_2_outline_driver_mirror_path_checks
"""
...
def main() -> int:
    ...
    block = doc.get("m3_repo_m2_2_outline_driver_mirror_path_checks") or {}
    if not block.get("enabled", True):
        print("m3_repo_m2_2_outline_driver_mirror_path_checks disabled")
        return 0
