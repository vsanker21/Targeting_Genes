#!/usr/bin/env python3
"""
Outline M2.2: presence check for maf_annotation_integration_stub pair under results/module3 (M3 manifest slice).

Config: config/m3_repo_m2_maf_annotation_outline_inputs.yaml — m3_repo_m2_maf_annotation_path_checks
"""
...
def main() -> int:
    ...
    block = doc.get("m3_repo_m2_maf_annotation_path_checks") or {}
    if not block.get("enabled", True):
        print("m3_repo_m2_maf_annotation_path_checks disabled")
        return 0
